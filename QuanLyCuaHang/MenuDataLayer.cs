...
namespace QuanLyCuaHang.DataLayer
{
    ...
    {
        private static MenuDataLayer instance;

        public static MenuDataLayer Instance
        {
            get { if (instance == null) instance = new MenuDataLayer(); return MenuDataLayer.instance; }
            private set { MenuDataLayer.instance = value; }
        }

        private MenuDataLayer() { }
